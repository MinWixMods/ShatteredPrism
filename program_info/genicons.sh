...
LAUNCHER_APPID="org.Noctilune.ShatteredPrism"
...
if command -v "inkscape" && command -v "icotool" && command -v "oxipng"; then
    ...
    svg2png ${LAUNCHER_APPID}.svg "$d/shatteredprism_16.png" 16 16
    svg2png ${LAUNCHER_APPID}.svg "$d/shatteredprism_24.png" 24 24
    svg2png ${LAUNCHER_APPID}.svg "$d/shatteredprism_32.png" 32 32
    svg2png ${LAUNCHER_APPID}.svg "$d/shatteredprism_48.png" 48 48
    svg2png ${LAUNCHER_APPID}.svg "$d/shatteredprism_64.png" 64 64
    svg2png ${LAUNCHER_APPID}.svg "$d/shatteredprism_128.png" 128 128
    svg2png ${LAUNCHER_APPID}.svg "$d/shatteredprism_256.png" 256 256

    oxipng --opt max --strip all --alpha --interlace 0 "$d/shatteredprism_"*".png"
